...
if(isset($_POST["religion"])&&isset($_POST["mother"])&&isset($_POST["country"]))
{
        if(!empty($_POST["religion"])&&!empty($_POST["mother"])&&!empty($_POST["country"]))
        {
         $query="select * from register where  religion='".$_POST['religion']."'&& country='".$_POST['country']."'&& mother='".$_POST['mother']."';";
